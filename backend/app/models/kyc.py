...
class CustomerProfile(BaseModel):
    ...
    kyc_level = Column(String(20), default="basic")  # basic, verified, premium
    credit_score = Column(Numeric(5, 2), default=0.00)  # 0-100
    ...
    document_type = Column(String(30), nullable=True)  # BI, Passaporte, etc
    ...
    def __repr__(self):
        return f"<CustomerProfile user={self.user_id} kyc={self.kyc_level}>"
